...
protected:
	...
	virtual inline const std::vector<std::string> GltfFileName() override { return { "BrainStem\\gltf\\BrainStem.gltf" }; }
	...
	virtual inline BOOL EnablePBRShading() override { return TRUE; }
