...
Dx12HelloSponza::Dx12HelloSponza(UINT width, UINT height) :
	Dx12SampleBase(width, height)
{
}

VOID Dx12HelloSponza::OnInit()
{
...
VOID Dx12HelloSponza::RenderFrameGfxDraw()
{
...
VOID Dx12HelloSponza::LoadSceneDescription(std::vector<DxSceneElementInstance>& sceneDescription)
{
...
DX_ENTRY_POINT(Dx12HelloSponza);
